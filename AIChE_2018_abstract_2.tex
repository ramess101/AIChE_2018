...
\begin{document}
	...
	\title{\Large \textbf{Reweighting molecular simulation configurations for rapid force field parameterization}}
			% prediction of vapor-liquid equilibria, $p\rho T$, and caloric properties}}
%	\author[1]{\large {Andrei Kazakov}}
	...
	%by providing a linear relationship between the total non-bonded energy and the non-bonded parameters. 
	
	 
	 
	%With this significant computational speed-up, we use a robust, high-dimensional, Bayesian optimization routine to simultaneously parameterize a Mie $n$-6 potential for several interaction sites. 
